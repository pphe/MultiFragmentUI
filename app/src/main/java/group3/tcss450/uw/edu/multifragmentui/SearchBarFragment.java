...
public class SearchBarFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mText = (AutoCompleteTextView) v.findViewById(R.id.autoCompleteTextView);
    ...
    public void onClick(View view) {
        Log.i("searchfrag", "in onClick()");
        switch (view.getId()) {
            case R.id.button:
                mListener.onFragmentInteraction(mText.getText().toString());
                break;
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        void onFragmentInteraction(String theText);
    }
}
